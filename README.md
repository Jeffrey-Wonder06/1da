...
<body>
    ...
    <script>
    var statuses = {
        "Abolude Testimony": "A bright light in the class, he's embodied a serene spirit, radiant heart, and a curious soul and mind. With a deep connection to the world's wonders, he inspired everyone to explore, dream, and grow. His presence was a blessing, leaving an indelible mark on our lives and hearts.",
